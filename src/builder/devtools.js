...
export function showLintingModal() {
  ...
  Object.assign(lintOverlay.style, {
    ...
    backgroundColor: 'transparent', zIndex: '20000',
  });
  ...
  Object.assign(iframe.style, {
    width: '100%', height: '100%', backgroundColor: 'transparent', border: 'none',  
  });
...
function showToast(msg) {
  ...
  Object.assign(el.style, {
    ...
    backgroundColor: '#FFF0DF', color: '#000', padding: '10px',
    borderRadius: '4px', zIndex: '10002', fontWeight: 'bold', cursor: 'pointer',
    fontSize: '14px', border: '2px #FF8C1A solid'
  });
  el.textContent = msg;
  el.onclick = () => { el.remove(); showLintingModal(); };
